...
plot_smooths(
  model=gam_mr,
  series=prop_hispanic
) + formatting +
  xlab("% hispanic")

plot_smooths(
  model=gam_mr,
  series=median_income_est
) + formatting +
  xlab("Median income")
...
plot_smooths(
  model=gam_mr,
  series=true_children_poverty
) + formatting +
  xlab("# children in poverty")

plot_smooths(
  model=gam_mr,
  series=true_children_total
) + formatting +
  xlab("# children")

plot_smooths(
  model=gam_mr,
  series=log(true_pop_total)
) + formatting +
...
plot_smooths(
  ...
  xlab("Racial homogeneity (Herfindahl index over all race categories")
  # geom_point(
  #   data=df_abbrv,
  #   aes(x=hhi, y=misalloc),
  #   alpha=0.1
  # ) +
  # ylim(-200000, 50000)
```
