...
ggplot(comparison_all, aes(x=reorder(race, sampling_benefit_per_child_eligible), y=sampling_benefit_per_child_eligible)) +
  plot +
  ylab("Race-weighted misallocation (sampling minus true) per eligible child")
ggsave("plots/misalloc_race_sampling.png", dpi=300, width=5, height=8)
