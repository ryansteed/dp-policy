...
lm_cov = lm(misalloc ~ prop_white + true_pop_total + true_children_total + true_children_poverty  + factor(trial) + factor(district_id) + state_fips_code, data=df)
lm2 = lm(sqrt(misalloc^2) ~ prop_white, data=df)
lm2_cov = lm(sqrt(misalloc^2) ~ prop_white + true_pop_total + true_children_total + true_children_poverty  + factor(trial) + factor(district_id) + state_fips_code, data=df)
