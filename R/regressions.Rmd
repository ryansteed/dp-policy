...
cplt = cowplot::plot_grid(
  plotlist=map2(
    list(
      gam(
        misalloc ~ s(true_children_total, bs="tp"),
        method="REML",
        data=df_reg
      ),
      gam(
        misalloc ~ s(true_children_poverty, bs="tp"),
        method="REML",
        data=df_reg
      ),
      gam(
      ...
      gam(
        misalloc ~ s(average_household_size_of_renter_occupied_unit_housing_tenure_est, bs="tp"),
        method="REML",
        data=df_reg
      )
    ),
