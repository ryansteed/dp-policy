...
ggplot(comparison_all, aes(x=reorder(race, race_benefit_per_child_eligible), y=race_benefit_per_child_eligible)) +
  ...
  xlab("Census Race Category") +
  ylab("Race-weighted misallocation (DP minus no DP)\n per eligible child")
ggsave("plots/misalloc_race.png", dpi=300, width=5, height=8)
...
ggsave("plots/smooths.png", plot, width=12, height=6, dpi=300)
