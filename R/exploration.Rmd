...
ggsave("plots/race/thresholds_raw.png", dpi=300, width=6, height=5)
...
ggsave("plots/race/thresholds_prop.png", dpi=300, width=6, height=5)
...
ggsave("plots/race/thresholds_raw_ethnicity.png", dpi=300, width=6, height=5)
...
ggsave("plots/race/thresholds_prop_ethnicity.png", dpi=300, width=6, height=5)
```
